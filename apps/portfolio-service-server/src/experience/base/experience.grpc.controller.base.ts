...
export class ExperienceGrpcControllerBase {
  ...
  @GrpcMethod("ExperienceService", "experiences")
  ...
  @GrpcMethod("ExperienceService", "experience")
  async experience(
  ...
  @swagger.ApiOkResponse({ type: Experience })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ExperienceService", "updateExperience")
  ...
  @swagger.ApiOkResponse({ type: Experience })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ExperienceService", "deleteExperience")
