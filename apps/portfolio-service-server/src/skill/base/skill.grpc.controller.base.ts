...
export class SkillGrpcControllerBase {
  ...
  @GrpcMethod("SkillService", "skills")
  ...
  @swagger.ApiOkResponse({ type: Skill })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SkillService", "updateSkill")
  async updateSkill(
    @common.Param() params: SkillWhereUniqueInput,
  ...
  @swagger.ApiOkResponse({ type: Skill })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SkillService", "deleteSkill")
  async deleteSkill(
    @common.Param() params: SkillWhereUniqueInput
  ): Promise<Skill | null> {
    try {
